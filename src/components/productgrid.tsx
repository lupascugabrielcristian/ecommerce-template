            ...
            {categories.map((category) => (
                <div className="mt-12  p-6" key={category.name}>
                    <div className="flex flex-row justify-between">
                        ...
                        { !showLink && (
                            <span className="grow rounded-md bg-sky-800 px-8 py-2 text-md font-medium text-white">
                                {category.name}
                            </span>
                        )}

                        { showLink && (
                            <NextLink className="grow rounded-md bg-sky-800 px-8 py-2 text-md font-medium text-white"
